...
execute @a[score_playerLeft_min=1] ~ ~ ~ title @s subtitle ["",{"selector":"@s","color":"aqua","bold":true},{"text":"!","color":"dark_aqua"}]
execute @a[score_playerLeft_min=1] ~ ~ ~ title @s title ["",{"text":"Welcome Back,","color":"dark_aqua"}]
